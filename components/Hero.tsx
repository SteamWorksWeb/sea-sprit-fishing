...
export default function Hero() {
  return (
    <header className="relative min-h-[600px] flex items-end overflow-hidden max-sm:min-h-[520px]">
      ...
      {/* Rating badge */}
      <div className="absolute top-[26px] right-[26px] z-[2] flex items-center gap-[9px] bg-coral text-white px-[15px] py-[10px] font-extrabold text-[13px] tracking-[0.02em] max-sm:top-4 max-sm:right-4 max-sm:left-4 max-sm:text-[10.5px] max-sm:py-2 max-sm:px-3 max-sm:justify-center rounded-[7px]">
      ...
      >
        ...
        <div className="flex gap-[14px] flex-wrap mt-[30px]">
          ...
          >
            Book Your Trip <ArrowRight size={17} />
          </a>
          <a
            href="#charters"
